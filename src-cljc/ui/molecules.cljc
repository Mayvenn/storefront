  ...
  (component/html
   [:picture
    ...
    (for [img-type       ["webp" "jpg"]
          [img-url opts] [[dsk-url {:src-set {"1x" {:w "1600"
                                                    :q "75"}}
                                    :media   "(min-width: 750px)"}]
                          [mob-url {:src-set {"1x" {:w "750"
                                                    :q "75"}
                                              "2x" {:w "1500"
                                                    :q "50"}}
                                    :media   "(min-width: 426px)"}]
                          [mob-url {:src-set {"1x" {:w "425"
                                                    :q "75"}
                                              "2x" {:w "850"
                                                    :q "50"}}
                                    :media   "(min-width: 321px)"}]
                          [mob-url {:src-set {"1x" {:w "320"
                                                    :q "75"}
                                              "2x" {:w "640"
                                                    :q "50"}}}]]]
      (ui/source img-url (assoc opts :type img-type)))
