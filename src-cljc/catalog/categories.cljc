...
(def experimental-closures [(merge {:catalog/category-id      "0"
...
(def experimental-virgin-hair [(merge {:catalog/category-id      "2"
...
(def experimental-wigs [(merge {:catalog/category-id "13"
                                :footer/order        20
                                :header/order        0
                                :header/group        2
...
(def experimental-stylist-exclusives [(merge {:catalog/category-id       "14"
...
(def dyed-hair-nav-roots [(merge {:catalog/category-id   "15"
