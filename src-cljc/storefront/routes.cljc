...
(def freeinstall-routes
  {{:subdomain freeinstall?}
   {"/"                                                        (edn->bidi events/navigate-adventure-home)
    ...
    "/adv/shop/a-la-carte/texture"                             (edn->bidi events/navigate-adventure-shopbybundles-hair-texture)
    "/adv/shop/a-la-carte/color"                               (edn->bidi events/navigate-adventure-shopbybundles-hair-color)
    "/adv/shop/a-la-carte/product-list"                        (edn->bidi events/navigate-adventure-shopbybundles-product-list)
