(ns storefront.components.slideout-nav
  (:require #?(:cljs [storefront.api :as api])
            ...
            [storefront.components.slideout-nav-202112 :as slideout-202112]
...
(defn built-component [data opts]
  (let [order-details? (experiments/order-details? data)]
    (if order-details?
      (component/build slideout-202112/component (slideout-202112/query data) nil)
