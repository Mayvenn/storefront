...
(def phone-ringing
  [:svg {:width "30", :height "30", :viewBox "0 0 29 29", :xmlns "http://www.w3.org/2000/svg"}
   [:title "3EBACC86-91F6-437D-A1EF-6970256603BA"]
   [:g {:fill "none", :fill-rule "evenodd"}
    [:g {:stroke "#323232", :stroke-width "1.2"}
...
(def mail-envelope
  [:svg {:width "30", :height "30", :viewBox "0 0 30 24", :xmlns "http://www.w3.org/2000/svg"}
   [:title "7FFCC1CC-163D-4023-86EB-8D872A3433AC"]
   [:g {:fill "none", :fill-rule "evenodd"}
    [:g {:stroke "#323232", :stroke-width "1.25"}
...
(def message
  (component/html
   [:svg {:width "30", :height "30", :viewBox "0 0 28 30", :xmlns "http://www.w3.org/2000/svg"}
    [:g {:fill "none", :fill-rule "evenodd"}
     [:g {:transform "translate(0 .268)", :stroke "#323232", :stroke-width "1.184"}
