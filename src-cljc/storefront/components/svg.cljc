...
(def micro-dollar-sign
  (component/html
   [:svg {:class "stroke-light-gray" :style {:width "14px" :height "14px"}}
...
(def large-dollar
  ...
  (component/html
   [:svg {:class "stroke-pure-white" :style {:width "72px" :height "72px"}}
...
(def large-payout
  (component/html
   [:svg {:class "stroke-pure-white" :style {:width "62px" :height "60px"}}
...
(def phone-ringing
  (component/html
   [:svg {:class "stroke-dark-black" :style {:width "30px" :height "30px"}}
...
(def counter-inc
  (component/html
   [:svg {:class "stroke-pure-white" :style {:width "1.2em" :height "1.2em"}}
...
(defn ^:private mayvenn-on-social [title xlink]
  (let [title-id (str "social-title-" xlink)]
    (component/html
     [:svg {:class "fill-dark-black" :role "img" :aria-labeledby title-id :style {:width "100%" :height "100%"}}
...
(def guarantee
  (component/html
   [:svg {:class "fill-green" :height "5em" :width "100%"}
    (svg-xlink "guarantee")]))
