...
(def prior-scroll-state (conj ui :prior-scroll-state))
(def restore-scroll-top (conj ui :restore-scroll-top))
(def navigation-message (conj ui :navigation-message))
(def navigation-event (conj navigation-message 0))
(def prior-navigation-message (conj ui :prior-navigation-message))
(def prior-navigation-event (conj prior-navigation-message 0))
