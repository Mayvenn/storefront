...
(def leads-ui-registration-password-confirmation (conj leads-ui-registration :password-confirmation))
...
(def leads-ui-registration-address1 (conj leads-ui-registration :address1))
(def leads-ui-registration-address2 (conj leads-ui-registration :address2))
(def leads-ui-registration-city (conj leads-ui-registration :city))
...
(def leads-ui-registration-paypal-email (conj leads-ui-registration :paypal-email))
(def leads-ui-registration-slug (conj leads-ui-registration :slug))
