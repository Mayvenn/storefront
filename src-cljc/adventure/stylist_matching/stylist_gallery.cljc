  ...
  (let [stylist-id (get-in data keypaths/stylist-profile-id)
    ...
    (when stylist
      {:header-data {:subtitle     [:div.mt2.h4.medium
                     ...
                     :header-attrs {:class "bg-white black border-bottom border-gray border-width-2"}
                     :right-corner {:id    "dismiss-email-capture"
                                    :opts  (utils/route-to events/navigate-adventure-stylist-profile {:stylist-id stylist-id
