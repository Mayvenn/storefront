...
(def bundle (conj ui :bundle))
(def bundle-previous-step (conj bundle :previous-step))
(def bundle-selected-variants (conj bundle :selected-variants))
(def bundle-selected-options (conj bundle :selected-options))
